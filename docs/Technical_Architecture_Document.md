...
This Technical Architecture Document provides comprehensive architectural design for the Civil Service Management System (CSMS). The system is built on modern, scalable architecture using Next.js 16 (frontend), Nest.js 10 (backend), PostgreSQL 15, and MinIO object storage, deployed on Ubuntu Server 24.04 LTS.

**Key Architecture Highlights:**
- **Architecture Pattern:** Decoupled Frontend-Backend with RESTful API
...
- **Performance:** Optimized for 100+ concurrent users, 50,000+ employee records
...
- **Decoupling:** Separate frontend and backend for scalability
- **Security:** Multi-layered security approach
- **Performance:** Optimized for fast response times
- **Maintainability:** Clean code structure with modular design
...
2. **Data Fetching Layer** - React Query for API calls
3. **Service Layer** - API service integration
4. **Utility Layer** - Helper functions and utilities

**Backend Layers:**
1. **Controller Layer** - API endpoints
2. **Middleware Layer** - Auth, logging, validation
...
**Email Service (SMTP):**
```
CSMS → Nest.js (nodemailer) → SMTP Server → Recipient
```
...
- Decorator-based syntax (clean code)
...
| Frontend   | Next.js           | 16.x    | Full-stack, SSR, modern      |
| Backend    | Nest.js           | 10.x    | Modular, TypeScript, scalable|
...
7. Restart PM2 processes (pm2 restart all)
8. Verify deployment
```
...
| 3000 | Next.js    | Internal   | Frontend server    |
| 3001 | Nest.js    | Internal   | Backend server     |
...
```
/www/wwwroot/frontend/        # Frontend code
/www/wwwroot/backend/         # Backend code
...
| 2.0     | Mar 24, 2026 | Architecture Team | Updated for Next.js + Nest.js architecture |
...
_For technical questions, contact: ict@zanajira.go.tz_

_Version 2.0 | March 24, 2026_
