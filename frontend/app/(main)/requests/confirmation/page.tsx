...
export default function ConfirmationRequestsPage() {
  ...
  const loadRequests = async () => {
    setLoading(true);
    const result = await requestService.getRequests({ type: 'confirmation' });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <h1 className="text-2xl font-bold text-gray-900">Confirmation Requests</h1>
          ...
          {canCreateRequest && (
            <button
              onClick={() => router.push('/requests/confirmation/new')}
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow">
            <p className="text-gray-500">No confirmation requests found</p>
          </div>
        ) : (
