...
export default function ResignationRequestsPage() {
  ...
  const loadRequests = async () => {
    setLoading(true);
    const result = await requestService.getRequests({ type: 'resignation' });
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
              ...
              <span>/</span>
              <span className="text-gray-900 font-medium">Resignation</span>
            </div>
          ...
          {canCreateRequest && (
            <button
              onClick={() => router.push('/requests/resignation/new')}
